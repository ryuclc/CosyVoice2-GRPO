...
class CosyVoiceFrontEnd:
    ...
    def frontend_zero_shot_2(self, tts_text, prompt_text, prompt_speech_16k, resample_rate, zero_shot_spk_id, add_space):
        if add_space:
            tts_text = prompt_text + " " + tts_text
        else:
            tts_text = prompt_text + tts_text
